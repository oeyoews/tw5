...
exports.onUpdate = function (myChart, state, addonAttributes) {
    ...
    function getData(year) {
        ...
        for (var time = startDate; time < endDate; time += dayTime) {
            ...
            data.push([
                ...
                $tw.wiki.filterTiddlers('[all[tiddlers]!is[shadow]!prefix[$:/state/]!prefix[$:/temp/]!tag[?]!tag[English]sameday:created[' + twtime + ']][all[tiddlers]!is[shadow]!prefix[$:/state/]!prefix[$:/temp/]!tag[?]!tag[EnglishWord]sameday:modified[' + twtime + ']]+[count[]]')
            ]);
        }
    ...
    myChart.on('click', 'series', function (params) {
        ...
        if (params.data[1] > 0) {
            ...
            var filter = "[all[tiddlers]!is[shadow]!prefix[$:/state/]!prefix[$:/temp/]!tag[?]!tag[EnglishWord]sameday:created[" + day + "]][all[tiddlers]!is[shadow]!prefix[$:/state/]!prefix[$:/temp/]!tag[EnglishWord]!tag[?]sameday:modified[" + day + "]+[sort[]]";
